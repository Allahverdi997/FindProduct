...
{
    public class GermanySearchProduct : SearchProduct
    {
        protected override void search(object sender, int id)
        {
            var product = CustomHttpClient.GetResponse("Germany", id).Result;
        ...
        {
            return CustomHttpClient.GetResponse("Germany", id).Result;
        }
    }
}
