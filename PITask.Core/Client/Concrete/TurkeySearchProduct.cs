...
{
    public class TurkeySearchProduct : SearchProduct
    {
        protected override void search(object sender, int id)
        {
            var product=CustomHttpClient.GetResponse("Turkey", id).Result;
        ...
        {
            return CustomHttpClient.GetResponse("Turkey", id).Result;
        }
    }
}
